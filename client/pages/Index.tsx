      ...
      <section className="bg-gradient-to-br from-sunstone-gold to-sunstone-gold-light py-4 md:py-16">
        <div className="max-w-4xl mx-auto px-3 md:px-8">
          <div className="text-center mb-4 md:mb-8">
            ...
            <p className="text-xs md:text-lg text-sunstone-black/80 max-w-2xl mx-auto">
          ...
          <div className="flex justify-center">
            <div className="bg-white rounded-xl shadow-2xl p-4 md:p-8 w-full max-w-md border border-sunstone-gold/20">
              <div className="flex items-center justify-center mb-4 md:mb-8">
                <h3 className="text-lg md:text-3xl font-bold text-sunstone-navy">
                  Apply Now
                </h3>
              </div>

              <form className="space-y-3 md:space-y-4" onSubmit={(e) => { e.preventDefault(); alert('Thank you for your interest! Our team will contact you soon.'); }}>
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="Enter your name"
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-3 focus:ring-sunstone-gold focus:border-sunstone-gold outline-none text-base text-sunstone-black font-medium placeholder-gray-500"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-3 focus:ring-sunstone-gold focus:border-sunstone-gold outline-none bg-white text-base text-sunstone-black font-medium"
                    required
                  >
                    <option value="" className="text-gray-500">
                      Select Program
                ...
                <Button
                  type="submit"
                  className="w-full bg-sunstone-navy hover:bg-sunstone-navy-dark text-sunstone-white py-3 md:py-4 text-lg md:text-xl font-bold rounded-xl shadow-lg"
                >
                  Send OTP
                </Button>
