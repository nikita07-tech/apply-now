              ...
              <div className="flex space-x-4 animate-scroll-x" style={{ width: "calc(500% + 80px)" }}>
                ...
                <div className="flex-shrink-0 w-80 bg-gradient-to-br from-white to-gray-50 rounded-2xl overflow-hidden shadow-2xl border border-sunstone-gold/30">
                  <div className="relative h-40">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                    <div className="absolute bottom-4 left-4 text-white">
                      <h3 className="text-lg font-bold">Hi-Tech Institute</h3>
                      <p className="text-sm">B.Tech • AICTE Approved</p>
                    </div>
                    <div className="absolute top-4 right-4 bg-sunstone-gold text-black px-3 py-1 rounded-full text-sm font-bold">
                      ₹4.59L
                    </div>
                ...
                <div className="flex-shrink-0 w-80 bg-gradient-to-br from-white to-gray-50 rounded-2xl overflow-hidden shadow-2xl border border-sunstone-gold/30">
                  <div className="relative h-40">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                    <div className="absolute bottom-4 left-4 text-white">
                      <h3 className="text-lg font-bold">VGU, Jaipur</h3>
                      <p className="text-sm">B.Tech • AICTE Approved</p>
                    </div>
                    <div className="absolute top-4 right-4 bg-sunstone-gold text-black px-3 py-1 rounded-full text-sm font-bold">
                      ₹7.00L
                ...
                <div className="flex-shrink-0 w-80 bg-gradient-to-br from-white to-gray-50 rounded-2xl overflow-hidden shadow-2xl border border-sunstone-gold/30">
                  <div className="relative h-40">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                    <div className="absolute bottom-4 left-4 text-white">
                      <h3 className="text-lg font-bold">Rathinam College</h3>
                      <p className="text-sm">BBA • AICTE Approved</p>
                    </div>
                    <div className="absolute top-4 right-4 bg-sunstone-gold text-black px-3 py-1 rounded-full text-sm font-bold">
                      ₹3.90L
                    </div>
              ...
              <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl overflow-hidden shadow-2xl border border-sunstone-gold/30 hover:border-sunstone-gold/60 transition-all duration-300">
                <div className="relative h-64 lg:h-72">
                  ...
                  <div className="absolute bottom-6 left-6 text-white">
                    <h3 className="text-2xl font-bold mb-2">Ajeenkya DY Patil University</h3>
                    <p className="text-lg opacity-90">Pune • BCA Program</p>
                    <p className="text-sm opacity-75">UGC Recognised</p>
                  </div>
            ...
            <div className="group cursor-pointer transform transition-all duration-500 hover:scale-105"
              ...
              <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl overflow-hidden shadow-2xl border border-sunstone-gold/30 hover:border-sunstone-gold/60 transition-all duration-300">
                <div className="relative h-64 lg:h-72">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                  <div className="absolute bottom-6 left-6 text-white">
                    <h3 className="text-2xl font-bold mb-2">Hi-Tech Institute</h3>
                    <p className="text-lg opacity-90">B.Tech Program</p>
                    <p className="text-sm opacity-75">AICTE Approved</p>
                  </div>
                  <div className="absolute top-6 right-6 bg-sunstone-gold text-black px-4 py-2 rounded-full font-bold">
                    ₹4.59 Lacs
            ...
            <div className="group cursor-pointer transform transition-all duration-500 hover:scale-105"
              ...
              <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl overflow-hidden shadow-2xl border border-sunstone-gold/30 hover:border-sunstone-gold/60 transition-all duration-300">
                <div className="relative h-64 lg:h-72">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                  <div className="absolute bottom-6 left-6 text-white">
                    <h3 className="text-2xl font-bold mb-2">Vivekananda Global University</h3>
                    <p className="text-lg opacity-90">Jaipur • B.Tech Program</p>
                    <p className="text-sm opacity-75">AICTE Approved</p>
                  </div>
                  <div className="absolute top-6 right-6 bg-sunstone-gold text-black px-4 py-2 rounded-full font-bold">
                    ₹7.00 Lacs
            ...
            <div className="group cursor-pointer transform transition-all duration-500 hover:scale-105"
              ...
              <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl overflow-hidden shadow-2xl border border-sunstone-gold/30 hover:border-sunstone-gold/60 transition-all duration-300">
                <div className="relative h-64 lg:h-72">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                  <div className="absolute bottom-6 left-6 text-white">
                    <h3 className="text-2xl font-bold mb-2">Rathinam College</h3>
                    <p className="text-lg opacity-90">Arts & Science • BBA</p>
                    <p className="text-sm opacity-75">AICTE Approved</p>
                  </div>
                  <div className="absolute top-6 right-6 bg-sunstone-gold text-black px-4 py-2 rounded-full font-bold">
                    ₹3.90 Lacs
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 text-gray-700">
                        <span className="w-2 h-2 bg-sunstone-gold rounded-full"></span>
                        <span className="text-sm font-medium">BBA (General)</span>
                      </div>
                      <div className="flex items-center gap-2 text-gray-700">
                        <span className="w-2 h-2 bg-sunstone-gold rounded-full"></span>
                        <span className="text-sm font-medium">10 Industry Certifications</span>
