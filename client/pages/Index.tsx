      ...
      <section className="py-16 md:py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            ...
            {/* SAGE Large Banner */}
            <div className="group cursor-pointer transform transition-all duration-500 hover:scale-105 animate-slide-in-left delay-200"
                 onClick={() => window.open('https://sunstone.in/campuses/sage', '_blank')}>
            ...
            <div className="group cursor-pointer transform transition-all duration-500 hover:scale-105 animate-slide-in-left delay-300"
                 onClick={() => window.open('https://sunstone.in/campuses/hitech', '_blank')}>
              <div className="bg-white rounded-3xl overflow-hidden shadow-2xl border border-gray-200 hover:border-sunstone-gold/60 transition-all duration-500 hover:shadow-3xl animate-float-up">
                <div className="relative h-64 lg:h-72">
                  <img
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-sunstone-navy mb-2">Hi-Tech Institute of Engineering</h3>
                  <p className="text-lg text-gray-600 mb-1">B.Tech Program</p>
                  <p className="text-sm text-gray-500 mb-4">AICTE Approved</p>
            ...
            <div className="group cursor-pointer transform transition-all duration-500 hover:scale-105 animate-slide-in-left delay-400"
              ...
              <div className="bg-white rounded-3xl overflow-hidden shadow-2xl border border-gray-200 hover:border-sunstone-gold/60 transition-all duration-500 hover:shadow-3xl animate-float-up">
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-sunstone-navy mb-2">Vivekananda Global University</h3>
                  <p className="text-lg text-gray-600 mb-1">Jaipur • B.Tech Program</p>
                  <p className="text-sm text-gray-500 mb-4">AICTE Approved</p>
            ...
            <div className="group cursor-pointer transform transition-all duration-500 hover:scale-105 animate-slide-in-left delay-500"
              ...
              <div className="bg-white rounded-3xl overflow-hidden shadow-2xl border border-gray-200 hover:border-sunstone-gold/60 transition-all duration-500 hover:shadow-3xl animate-float-up">
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-sunstone-navy mb-2">Rathinam College of Arts & Science</h3>
                  <p className="text-lg text-gray-600 mb-1">BBA Program</p>
                  <p className="text-sm text-gray-500 mb-4">AICTE Approved</p>
